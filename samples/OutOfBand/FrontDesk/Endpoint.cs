...
namespace World
{
    internal class Program
    {
        ...
        private static readonly NLog.ILogger Logger = LogManager.GetLogger("FrontDesk");
        ...
        private static void Main(string[] args)
        {
            ...
            _container = new Container(x =>
            {
                ...
                x.Scan(y =>
                {
                    ...
                    y.AssembliesFromApplicationBaseDirectory((assembly) => assembly.FullName.StartsWith("FrontDesk"));
