...
namespace Hello
{
    internal class Program
    {
        ...
        private static void SetupMetrics()
        {
            Metric.Config
                .WithAppCounters()
                .WithHttpEndpoint("http://localhost:1111/");
        }
        ...
        private static void Main(string[] args)
        {
            ...
            _container = new Container(x =>
            {
                ...
                x.Scan(y =>
                {
                    ...
                    y.AssembliesFromApplicationBaseDirectory((assembly) => assembly.FullName.StartsWith("Sender"));
            ...
            do
            {
                bus.Send(new Command { Guid = Guid.NewGuid() });
                Thread.Sleep(100);
            } while (running);
