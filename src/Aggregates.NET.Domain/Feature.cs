...
namespace Aggregates
{
    public class Feature : NServiceBus.Features.Feature
    {
        protected override void Setup(FeatureConfigurationContext context)
        {
            ...
            // Remove the convention checker
            // Why?  Because the Dispatcher is going to use SendLocal to feedback events generated by the endpoint.  EnforceBestPractices doesn't allow it
            context.Pipeline.Remove(NServiceBus.Pipeline.WellKnownStep.EnforceBestPractices);
