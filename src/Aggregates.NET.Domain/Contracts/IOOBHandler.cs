...
namespace Aggregates.Contracts
{
    public interface IOobHandler
    {
        ...
        Task<IEnumerable<IFullEvent>> Retrieve<T>(string bucket, Id streamId, IEnumerable<Id> parents, long skip, int take, bool ascending = true) where T : class, IEventSource;
