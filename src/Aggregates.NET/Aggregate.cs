...
{
    public abstract class Aggregate<TId> : Entity<TId>, IAggregate<TId>, IHaveEntities, INeedBuilder, INeedStream, INeedRepositoryFactory
    {
        ...
        public IEntityRepository<TEntity> E<TEntity>() where TEntity : class, IEntity
        {
            return Entity<TEntity>();
        }

        public IEntityRepository<TEntity> Entity<TEntity>() where TEntity : class, IEntity
        {
            ...
            return (IEntityRepository<TEntity>)(_repositories[type] = (IEntityRepository)_repoFactory.ForEntity<TEntity>(_builder, _eventStream));
        }
    }
}